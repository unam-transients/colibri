...
Figure~\ref{figure:plot-D-prime} shows $D'$, the value of $D$ after displacing the dome by 15~mm at an azimuth of 300 degrees, assuming the dome moves rigidly. The P-V is reduced from 40 mm to 23 mm. Figure~\ref{figure:plot-G-prime} shows $G'$, the value of G after displacing the dome by 11~mm at an azimuth of 285 degrees, assuming the dome moves rigidly. The P-V is reduced from 43 to 27 mm.
